...
# DEFAULT_POLICY_NAME="act_sjaj_gripper-box-orig"
# DEFAULT_POLICY_NAME="act_sjaj_gripper-box-refined-cg-off"
# DEFAULT_POLICY_NAME="act_sjaj_gripper-box-orig-cg-on"
# DEFAULT_POLICY_NAME="act_sjaj_gripper-box-orig-bin-on"
